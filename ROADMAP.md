...
|---|---------------|--------|
| 1 | Atomic Structure Builder | **building now** |
| 2 | Electron Configuration & Shells | planned |
| 3 | Periodic Table Explorer (annotated trends) | planned |
| 4 | Chemical Bonding (covalent focus) | planned |
